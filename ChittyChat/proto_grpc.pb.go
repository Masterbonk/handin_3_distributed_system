...
func (c *chittyChatClient) Chat(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ClientMessage, ServerMessage], error) {
...
type ChittyChat_ChatClient = grpc.BidiStreamingClient[ClientMessage, ServerMessage]
...
func (UnimplementedChittyChatServer) Chat(grpc.BidiStreamingServer[ClientMessage, ServerMessage]) error {
...
func _ChittyChat_Chat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChittyChatServer).Chat(&grpc.GenericServerStream[ClientMessage, ServerMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChittyChat_ChatServer = grpc.BidiStreamingServer[ClientMessage, ServerMessage]
...
var ChittyChat_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "ChittyChat/proto.proto",
}
